...
public class SearchController implements Initializable {
    ...
    private void populateProductDetailView(ShoppingItem shoppingItem){
        ...
        priceOfproductInfo.setText(shoppingItem.getProduct().getPrice() + " kr");
        itemNumber.setText("Artikelnummer: " + shoppingItem.getProduct().getProductId());
        ekologiskInfo.setText(isEco(shoppingItem.getProduct()));
    }
